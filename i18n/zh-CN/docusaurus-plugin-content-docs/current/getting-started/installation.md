...
The default port for Answer is `9080`. You can access it at <http:>.
...
After running the command, heading to <http:> to continue installation.
...
🎉Congratulations, you can click the done button to start your answer journey! ![install-complete](/img/docs/install-complete.png)
